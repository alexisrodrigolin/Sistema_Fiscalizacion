...
class main():
    ...
    def create_widget_precio(self):
        ...
        self.P_plu= tb.Label(self.app, text= "PLU:", font= ("helvetica", 15))
        self.P_plu_value= tb.Entry(self.app, style= "darkly",width=15)
        self.P_plu2= tb.Label(self.app, text= "PLU 2:", font= ("helvetica", 15))
        self.P_plu2_value= tb.Entry(self.app, style= "darkly",width=15)
        self.P_precio= tb.Label(self.app, text= "Precio:", font= ("helvetica", 15))
        self.P_precio_value= tb.Entry(self.app, style= "darkly", width=15, font= ("helvetica",15))
        self.P_marca= tb.Label(self.app, text= "Marca:", font= ("helvetica", 15))
        self.P_marca_value= tb.Entry(self.app, style= "darkly", width=15, font= ("helvetica", 15))
        self.P_descripcion= tb.Label(self.app, text= "Descripcion:", font= ("helvetica", 15))
        self.P_descripcion_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=21)
        self.P_tipo= tb.Label(self.app, text= "Tipo/Sabor:", font= ("helvetica", 15))
        self.P_tipo_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=20)
        self.P_cantidad= tb.Label(self.app, text= "Cantidad:", font= ("helvetica", 15))
        ...
        self.P_departamento= tb.Label(self.app, text= "Deepartamento:", font= ("helvetica", 15))
        self.P_departamento_value= tb.Entry(self.app, style= "darkly", width=14, font= ("helvetica", 15))
        self.P_pasillo= tb.Label(self.app, text= "Pasillo:", font= ("helvetica", 15))
        self.P_pasillo_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=14)
        self.P_costo= tb.Label(self.app, text= "Costo s.IVA:", font= ("helvetica", 15))
        self.P_costo_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=7)
        self.P_iva= tb.Label(self.app, text= "IVA:", font= ("helvetica", 15))
        self.P_iva_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=7)
        self.P_ganancia= tb.Label(self.app, text= "Ganancia %:", font= ("helvetica", 15))
        self.P_ganancia_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=7)
        self.P_preReco= tb.Label(self.app, text= f"Precio recomendado \n para venta: $", font= ("helvetica", 15), foreground="#B6B6B6")

        self.P_preCan= tb.Label(self.app, text= f"<<<Precio por Cantidad>>>", font= ("helvetica", 15))
        self.P_cantidad1= tb.Label(self.app, text= "Cantidad 1:", font= ("helvetica", 15))
        self.P_cantidad1_value= tb.Entry(self.app, style= "darkly", width=7, font= ("helvetica", 15))
        self.P_cantidad2= tb.Label(self.app, text= "Canridad 2:", font= ("helvetica", 15))
        self.P_cantidad2_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=7)
        self.P_cantidad3= tb.Label(self.app, text= "Cantidad 3:", font= ("helvetica", 15))
        self.P_cantidad3_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=7)
        self.P_precioC1= tb.Label(self.app, text= "Precio x Uni:", font= ("helvetica", 15))
        self.P_precioC1_value= tb.Entry(self.app, style= "darkly", font= ("helvetica", 15), width=7)
        self.P_precioC2= tb.Label(self.app, text= "Precio x Uni:", font= ("helvetica", 15))
