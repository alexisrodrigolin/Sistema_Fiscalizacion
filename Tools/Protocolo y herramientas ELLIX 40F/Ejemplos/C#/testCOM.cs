...
namespace test
{
    class Program
    {
		static void cmd_error(string cmdname, Sam4sFiscalDriver.Sam4sFiscalDriver drv)
		{
        ...
        static int Main(string[] args)
        {
			...
			Sam4sFiscalDriver.Sam4sFiscalDriver drv = new Sam4sFiscalDriver.Sam4sFiscalDriver();
