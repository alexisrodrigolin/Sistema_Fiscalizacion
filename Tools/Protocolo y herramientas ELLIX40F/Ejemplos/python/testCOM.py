...
def main ():
	...
	drv = win32com.client.Dispatch("Sam4sFiscalDriver.Sam4sFiscalDriver")
	print("Version %s" % drv.version)
	...
	if not drv.SerialPortOpen(args.comnum):
		print("Error: no se pudo abrir el puerto serial %d" % args.comnum)
		exit(2)
	...
	if args.testname == "info": # Información del equipo
		...
		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Item de prueba 1')
		drv.IFOpParamFloatSet("Cantidad", 3.0)
		drv.IFOpParamFloatSet("Precio", 1.2345)
		drv.IFOpParamFloatSet("IVA", 21.0)
		...
		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Item de prueba 2')
		...
		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Item de prueba 3')
		...
		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Item de prueba 4')
		...
		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Item de prueba 5')
		...
		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Item de prueba 6')
		...
		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Item de prueba 7')
		...
		print(" CantidadItems: %s" % drv.IFOpRetGet("CantidadItems"))
		...
		drv.IFOpParamSet("Descripcion", u'Decuento articulo')
		drv.IFOpParamFloatSet("Cantidad", 3.0)
		...
		drv.IFOpParamSet("Descripcion", u'Item de se\xf1a')
		drv.IFOpParamFloatSet("Cantidad", 3.0)
		...
		drv.IFOpParamSet("Descripcion", u'Oferta del d\xeda')
		...
		drv.IFOpParamSet("Descripcion", u'Recargo administrativo')
		...
		print("Pago")
		drv.IFOpBegin("Pago")
		drv.IFOpParamSet("Descripcion", u'CTA 123458')
		drv.IFOpParamFloatSet("Monto", 20.0)
		drv.IFOpParamIntSet("CodigoTipo", 6)
		drv.IFOpParamSet("TextoLibre", u'Vencimiento XX/XX/XXXX')
		if not drv.IFOpSend(1):
			cmd_error("Pago",drv)
		print(" MontoFaltaPagar: %f" % drv.IFOpRetFloatGet("MontoFaltaPagar"))
		...
		print("Pago")
		drv.IFOpBegin("Pago")
		drv.IFOpParamSet("Descripcion", u'Tarjeta XXXX')
		drv.IFOpParamFloatSet("Monto", 5.0)
		drv.IFOpParamIntSet("CodigoTipo", 20)
		drv.IFOpParamSet("Cuotas", u'12')
		drv.IFOpParamSet("Cupones", u'XXX-XX-XXXX')
		if not drv.IFOpSend(1):
			cmd_error("Pago",drv)
		print(" MontoFaltaPagar: %f" % drv.IFOpRetFloatGet("MontoFaltaPagar"))
		...
		drv.IFOpParamSet("Texto", u'L\xednea de texto no fiscal')
		if not drv.IFOpSend(1):
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'Dato libre')
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'09/14')
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'L\xednea libre 1 (opcional)')
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'L\xednea libre 2 (opcional)')
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'L\xednea libre 3 (opcional)')
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'L\xednea libre 4 (opcional)')
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'L\xednea libre 5 (opcional)')
		...
		print("TextoNoFiscal")
		drv.IFOpBegin("TextoNoFiscal")
		drv.IFOpParamSet("Texto", u'L\xednea libre 6 (opcional)')
		...
		print("TextoFiscal")
		drv.IFOpBegin("TextoFiscal")
		drv.IFOpParamSet("Texto", u'Descripci\xf3n l\xednea 1')
		if not drv.IFOpSend(1):
			cmd_error("TextoFiscal",drv)

		print("TextoFiscal")
		drv.IFOpBegin("TextoFiscal")
		drv.IFOpParamSet("Texto", u'Descripci\xf3n l\xednea 2')
		if not drv.IFOpSend(1):
			cmd_error("TextoFiscal",drv)

		print("TextoFiscal")
		drv.IFOpBegin("TextoFiscal")
		drv.IFOpParamSet("Texto", u'Descripci\xf3n l\xednea 3')
		if not drv.IFOpSend(1):
			cmd_error("TextoFiscal",drv)

		print("TextoFiscal")
		drv.IFOpBegin("TextoFiscal")
		drv.IFOpParamSet("Texto", u'Descripci\xf3n l\xednea 4')
		if not drv.IFOpSend(1):
			cmd_error("TextoFiscal",drv)

		print("ItemVenta")
		drv.IFOpBegin("ItemVenta")
		drv.IFOpParamSet("Descripcion", u'Descripci\xf3n l\xednea 5')
		...
		print(" Numero: %d" % drv.IFOpRetIntGet("Numero"))
		print(" Texto: %s" % drv.IFOpRetGet("Texto"))

		print("EstablecerEncabezadoCola")
		drv.IFOpBegin("EstablecerEncabezadoCola")
		drv.IFOpParamIntSet("Numero", 19)
		drv.IFOpParamSet("Texto", u'Cola libre 9')
		if not drv.IFOpSend(1):
			cmd_error("EstablecerEncabezadoCola",drv)
